    ...
    <>
      <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-3 pl-8 cursor-pointer'>
            <input  type="text"  placeholder="Search"  className="w-96 bg-gray-900 p-2 border-white rounded-md f" />
        ...
        <div className='flex items-center gap-4'>
          {
            isLoggedIn ? (
             ...
             <>
              <Link to='/register'> <p className='bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer'>Signup</p></Link>
              <Link to='/login'><button className='bg-white text-black text-[15px] px-4 py-2 rounded-2xl hidden md:block cursor-pointer'>Login</button></Link>
             </>
            )
          }
        </div>
